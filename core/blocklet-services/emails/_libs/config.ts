import { ASSET_CHAIN_ID, BETA_CHAIN, INFURA_PROJECT_ID, DEFAULT_BETA_HOST, DEFAULT_MAIN_HOST } from './constant';
...
export const ETHEREUM_CHAIN = `${EVM_PREFIX}1`;
export const ROPSTEN_CHAIN = `${EVM_PREFIX}3`;
export const RINKEBY_CHAIN = `${EVM_PREFIX}4`;
export const GOERLI_CHAIN = `${EVM_PREFIX}5`;
export const KOVAN_CHAIN = `${EVM_PREFIX}42`;
export const BINANCE_CHAIN = `${EVM_PREFIX}56`;
export const BINANCE_TEST_CHAIN = `${EVM_PREFIX}97`;
export const ETHEREUM_FAIR_CHAIN = `${EVM_PREFIX}513100`;
export const ARBITRUM_CHAIN = `${EVM_PREFIX}42161`;
export const ARBITRUM_TEST_CHAIN = `${EVM_PREFIX}421611`;
export const ETHEREUM_CLASSIC_CHAIN = `${EVM_PREFIX}61`;
export const ETHEREUM_CLASSIC_MORDOR_CHAIN = `${EVM_PREFIX}63`;
...
export const getConfigByChainId = (chainId: string) => {
  let Id = chainId;
  try {
  ...
  return evmConfig[CHAIN[Id as keyof typeof CHAIN]];
};
