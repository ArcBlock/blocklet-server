module.exports = `# Code generated by protoc-gen-gogql. DO NOT EDIT
...
input BlockletAccessPolicyQueryInput {
	search: String
}
...
input BlockletResponseHeaderPolicyQueryInput {
	search: String
}

input BlockletSecurityRuleInput {
	id: String
	pathPattern: String
	componentDid: String
	priority: Uint32
	...
	enabled: Boolean
	remark: String
	accessPolicy: BlockletAccessPolicyInput
	responseHeaderPolicy: BlockletResponseHeaderPolicyInput
}

input BlockletSecurityRuleQueryInput {
	search: String
}
...
input QueryUserFollowStateOptionsInput {
...
input RequestAddBlockletResponseHeaderPolicyInput {
	did: String
	data: BlockletResponseHeaderPolicyInput
}

input RequestAddBlockletSecurityRuleInput {
	did: String
	data: BlockletSecurityRuleInput
}
...
input RequestAddUploadEndpointInput {
	teamDid: String
	url: String
	scope: String
}
...
input RequestDeleteBlockletAccessPolicyInput {
	did: String
	id: String
}

input RequestDeleteBlockletResponseHeaderPolicyInput {
	did: String
	id: String
}

input RequestDeleteBlockletSecurityRuleInput {
	did: String
	id: String
}
...
input RequestDeleteUploadEndpointInput {
	teamDid: String
	did: String
	scope: String
	projectId: String
...
input RequestDisconnectFromEndpointInput {
	did: String
	endpointId: String
	projectId: String
}
...
input RequestGetBlockletAccessPoliciesInput {
	did: String
	paging: PagingInput
	query: BlockletAccessPolicyQueryInput
}

input RequestGetBlockletAccessPolicyInput {
	did: String
	id: String
}
...
input RequestGetBlockletResponseHeaderPoliciesInput {
	did: String
	paging: PagingInput
	query: BlockletResponseHeaderPolicyQueryInput
}

input RequestGetBlockletResponseHeaderPolicyInput {
	did: String
	id: String
}

input RequestGetBlockletSecurityRuleInput {
	did: String
	id: String
}

input RequestGetBlockletSecurityRulesInput {
	did: String
	paging: PagingInput
	query: BlockletSecurityRuleQueryInput
...
input RequestPublishToEndpointInput {
	did: String
	endpointId: String
	projectId: String
	releaseId: String
...
input RequestRegenerateWebhookEndpointSecretInput {
	teamDid: String
	id: String
}
...
input RequestRotateSessionKeyInput {
	teamDid: String
	sessionId: String
}
...
input RequestSyncFederatedInput {
	did: String
}

input RequestSyncMasterAuthorizationInput {
	did: String
}
...
input RequestUpdateBlockletAccessPolicyInput {
	did: String
	data: BlockletAccessPolicyInput
}

input RequestUpdateBlockletResponseHeaderPolicyInput {
	did: String
	data: BlockletResponseHeaderPolicyInput
}

input RequestUpdateBlockletSecurityRuleInput {
	did: String
	data: BlockletSecurityRuleInput
}
...
type BlockletResponseHeaderPolicy {
	id: String
	name: String
	description: String
	securityHeader: String
...
type ResponseBlockletAccessPolicies {
	code: StatusCode
	accessPolicies: [BlockletAccessPolicy!]
	paging: Paging
}

type ResponseBlockletAccessPolicy {
	code: StatusCode
	accessPolicy: BlockletAccessPolicy
}
...
type ResponseBlockletResponseHeaderPolicies {
	code: StatusCode
	responseHeaderPolicies: [BlockletResponseHeaderPolicy!]
	paging: Paging
}

type ResponseBlockletResponseHeaderPolicy {
	code: StatusCode
	responseHeaderPolicy: BlockletResponseHeaderPolicy
}
...
type ResponseBlockletSecurityRule {
	code: StatusCode
	securityRule: BlockletSecurityRule
}

type ResponseBlockletSecurityRules {
	code: StatusCode
	securityRules: [BlockletSecurityRule!]
	paging: Paging
}
...
type ResponseConnectToEndpoint {
	code: StatusCode
	url: String
}
...
type ResponsePublishToEndpoint {
	code: StatusCode
	url: String
}
...
type ResponseRegenerateWebhookEndpointSecret {
	secret: String
}
...
type ResponseRestartAllContainers {
	code: StatusCode
	sessionId: String
}
...
type Mutation {
	...
	syncMasterAuthorization(input: RequestSyncMasterAuthorizationInput): ResponseBlocklet
	syncFederatedConfig(input: RequestSyncFederatedInput): ResponseBlocklet
	...
	addBlockletSecurityRule(input: RequestAddBlockletSecurityRuleInput): ResponseBlockletSecurityRule
	updateBlockletSecurityRule(input: RequestUpdateBlockletSecurityRuleInput): ResponseBlockletSecurityRule
	deleteBlockletSecurityRule(input: RequestDeleteBlockletSecurityRuleInput): GeneralResponse
	addBlockletResponseHeaderPolicy(input: RequestAddBlockletResponseHeaderPolicyInput): ResponseBlockletResponseHeaderPolicy
	updateBlockletResponseHeaderPolicy(input: RequestUpdateBlockletResponseHeaderPolicyInput): ResponseBlockletResponseHeaderPolicy
	deleteBlockletResponseHeaderPolicy(input: RequestDeleteBlockletResponseHeaderPolicyInput): GeneralResponse
	addBlockletAccessPolicy(input: RequestAddBlockletAccessPolicyInput): ResponseBlockletAccessPolicy
	...
	regenerateWebhookEndpointSecret(input: RequestRegenerateWebhookEndpointSecretInput): ResponseRegenerateWebhookEndpointSecret
...
type Query {
	...
	getBlockletSecurityRule(input: RequestGetBlockletSecurityRuleInput): ResponseBlockletSecurityRule
	getBlockletSecurityRules(input: RequestGetBlockletSecurityRulesInput): ResponseBlockletSecurityRules
	getBlockletResponseHeaderPolicy(input: RequestGetBlockletResponseHeaderPolicyInput): ResponseBlockletAccessPolicy
