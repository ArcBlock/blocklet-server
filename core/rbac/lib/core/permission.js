...
module.exports = class Permission extends Base {
  /**
   ...
   * @param {String} opt.title Title of the permission
   * @param {String} opt.description Description of the permission
   * @param {String} opt.extra Extra info of the permission
   */
  constructor(rbac, action, resource, { title, description, extra } = {}) {
    if (!action || !resource) {
    ...
    super(rbac, Permission.createName(action, resource, rbac.options.delimiter), { title, description, extra });
  }
